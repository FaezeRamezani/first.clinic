...
export const NewAppointmentModal = () => {
    const { isNewAppointmentOpen, setIsNewAppointmentOpen, newAppointmentPrefill, patients, doctors, services, addAppointment, selectedPatient, checkAppointmentConflict, appointments } = useClinic();
