...
export const Sidebar = () => {
    const { activeView, setActiveView, scope, onlineRequests, followUps, appointments, openNewAppointment, setIsNewPatientOpen } = useClinic();
